...
namespace CustomerCall
{
    ...
    public abstract class CallPlan
    {
        ...
        internal virtual void recordCall(int minutes)
        {
            CustCall.valueCall(minutes);
        }
        internal void SetTypeCall(Call typeCall)
        {
            CustCall = typeCall;
        }
    }
    public class CallPlanSimple : CallPlan
    {
        ...
        internal override void recordCall(int minutes)
        {
            base.recordCall(minutes);
        }
    }
    public class CallPlanFree2andMinuteAfter10 : CallPlan
    {
    ...
    public class CallPlanTwiceCheaperFirst5Minutes : CallPlan
    {
    ...
    public class Call
    {
        ...
        internal void valueCall(int minutes)
        {
            if (CallType == 'Г')
